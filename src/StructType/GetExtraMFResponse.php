...
class GetExtraMFResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getExtraMFResponseMidocoMfItem) {
            ...
            if (!$getExtraMFResponseMidocoMfItem instanceof \Pggns\MidocoApi\MidocoSystem\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\MidocoSystem\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\MidocoSystem\StructType\GetExtraMFResponse
     */
