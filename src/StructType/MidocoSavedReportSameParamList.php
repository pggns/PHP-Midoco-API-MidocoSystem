...
class MidocoSavedReportSameParamList extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\MidocoSystem\StructType\MidocoJasperReportExt $midocoJasperReportExt = null, array $midocoJasperReportParamValue = [])
    {
        $this
